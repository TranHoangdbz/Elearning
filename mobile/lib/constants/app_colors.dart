...
class AppColors {
  AppColors._();
  static const Color primaryColor = Color(0xff040E53);
  static const Color primaryColorDark = Color(0xff363E75);
  static const Color primaryColorLight = Color(0xff8185A9);
