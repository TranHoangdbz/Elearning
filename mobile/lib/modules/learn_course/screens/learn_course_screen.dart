...
class LearnCourseScreen extends StatelessWidget {
  final Course course;
  final Lesson lesson;
  LearnCourseScreen({Key? key, required this.course, required this.lesson})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    vidcontroller = VideoPlayerController.network(
        // "https://www.youtube.com/watch?v=sMcfFmR0MmA"
        lesson.video);
    return GetBuilder<LearnCoursesController>(builder: (_controller) {
